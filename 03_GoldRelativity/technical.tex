...
This contraction has consequences for interband transitions and optical properties, as discussed in the following section.
    ...
    \item \textbf{Platinum (Silvery-white)}: In Pt (5d$^9$6s$^1$), relativistic effects also contract $6s$ and modify the $5d$ manifold, but the detailed band filling and $d$-band position keep the main interband onset in the ultraviolet. As a result, the reflectivity is relatively flat across the visible, so platinum appears silvery-white rather than strongly colored, in contrast to gold.
    
    \item \textbf{Mercury (Liquid)}: Relativistic contraction of the 6s$^2$ shell in Hg lowers and localizes these electrons, reducing 6s–6s overlap and narrowing the 6s band. Metallic bonding is therefore unusually weak, and dispersion (van der Waals–type) interactions play a relatively larger role compared to typical metals. This weakened cohesion explains mercury's anomalously low melting point of -38.8°C and its liquid state at room temperature.
    \end{itemize}
